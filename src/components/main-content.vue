<template>
  <div class="main-content">
    <el-row type="flex"
      ...
      <el-col :xl="5"
              :lg="5"
              class="main-left hidden-md-and-down">
        <el-card :body-style="{ padding: '0px' }">
          ...
          <!-- card body -->
          <div v-if="recommendArticles&&recommendArticles[0]"
               class="left-article">
      ...
      <el-col :xl="5"
              :lg="5"
              class="main-right hidden-md-and-down">
        <el-card :body-style="{ padding: '0px' }">
          <div slot="header"
               class="right-header">
  ...
  methods: {
    ...
    getArticles() {
      ...
      this.GET_ARTICLE_LIST({
        article: { articleState: ARTICLE_STATE_MAP.PUBLISHED },
        start: 0,
        count: 10
      })
        .then(data => {
