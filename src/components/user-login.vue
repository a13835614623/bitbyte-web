<template>
  <div class="block login">
    <el-form :model="user" :rules="userRules" ref="user" label-width="0" hide-required-asterisk>
  ...
  data() {
    ...
    let validatePassword = (rule, value, callback) => {
      if (!value) {
        ...
        return callback(new Error("密码长度不能小于7个字符"));
      }
      callback();
    };
    return {
          ...
          axios
            ...
            .then(res => {
              ...
              if (res.data.status == "success") {
                ...
                Cookies.set('user', vm.user.username, { expires: 7 })
                setTimeout(() => {
